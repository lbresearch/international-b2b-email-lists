# Twitter Users Email List Database

> **100,000,000 verified contacts available.** Get the full Twitter Users Email List Database at **[LeadsBlue](https://leadsblue.com/leads/twitter-users-email-list-database/)**.

A data-backed overview of the **Twitter Users Email List Database** — audience size, email engagement benchmarks, optimal send timing, and compliance notes for outreach.

## Key figures

| Metric | Value |
|---|---|
| Verified contacts | **100,000,000** |
...
**How many contacts are in the Twitter Users Email List Database?**  
The list contains 100,000,000 verified contacts.
...
The complete, verified **Twitter Users Email List Database** — with individual contact records ready for outreach — is available from LeadsBlue:

**→ [Twitter Users Email List Database on LeadsBlue](https://leadsblue.com/leads/twitter-users-email-list-database/)**
